              ...
              <div class="bg-gray-50 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                <div class="sm:flex sm:items-start">
                  ...
                  <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                    <h3 class="text-lg font-medium leading-6 text-gray-600" id="modal-title">Add Judge</h3>
                    <div class="mt-2 text-gray-700">
                        <div class="mb-4">
                            <label class="block uppercase text-xs font-bold mb-2" for="firstname">Judge First Name</label>
                             <x-text-input class="w-full" wire:model="form.firstname" id="firstname" type="text" name="firstname" :value="old('firstname')" autofocus autocomplete="firstname" ></x-text-input>
                        ...
                        <div class="mb-4">
                            <label class="block uppercase text-xs font-bold mb-2" for="lastname">Judge Last Name</label>
                             <x-text-input class="w-full" wire:model="form.lastname" id="lastname" type="text" name="lastname" :value="old('lastname')" autofocus autocomplete="lastname" ></x-text-input>
