                    ...
                    <tr class="bg-gray-100 border-b border-b-gray-200">
                        ...
                        @foreach($judges as $judge)
                            <td class="py-4 px-6 text-center">
                                @if(!empty($judge->portfolio->where('contestant_id', $contestant->id)->first()))
                                {{ $judge->portfolio->where('contestant_id', $contestant->id)->first()->score }}
                                @else
